...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttons[11] = findViewById(R.id.buttonP);
        buttons[12] = findViewById(R.id.buttonM);
        buttons[13] = findViewById(R.id.buttonY);
        buttons[14] = findViewById(R.id.buttonD);
        buttons[15] = findViewById(R.id.buttonS);
